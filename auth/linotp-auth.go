...
func CheckAuth(token string) (bool, string, string) {

	// Parse username:password from base64 encoded token
	username, password := getCreds(token)
...
func getCreds(token string) (string, string) {
...
func ParseResponse (body []byte) (*LinotpResponse, error) {
